...
using Zebble;
using Android;
using Fingerprint.Utils;

namespace Fingerprint.Dialog
{
    public class FingerprintDialogFragment : DialogFragment, IAuthenticationFailedListener, IDialogInterfaceOnKeyListener
    {
        ...
        private Android.Widget.TextView _helpText;
        private Android.Widget.Button _cancelButton;
        private Android.Widget.Button _fallbackButton;
        private Android.Widget.ImageView _icon;
        private bool _canceledByLifecycle;
        private CancellationTokenSource _cancelationTokenSource;
        private IAndroidFingerprintImplementation _implementation;

        protected Android.Graphics.Color NegativeColor = new Android.Graphics.Color(217, 59, 59);
        protected Android.Graphics.Color PositiveColor = new Android.Graphics.Color(90, 185, 83);
        ...
        public override Android.Views.View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            view.FindViewById<Android.Widget.TextView>(Resource.Id.fingerprint_txtReason).Text = Configuration.Reason;

            _helpText = view.FindViewById<Android.Widget.TextView>(Resource.Id.fingerprint_txtHelp);
            _cancelButton = view.FindViewById<Android.Widget.Button>(Resource.Id.fingerprint_btnCancel);
            _fallbackButton = view.FindViewById<Android.Widget.Button>(Resource.Id.fingerprint_btnFallback);
            _icon = view.FindViewById<Android.Widget.ImageView>(Resource.Id.fingerprint_imgFingerprint);
        ...
        private async Task FinalAnimationAsync(Android.Graphics.Color color)
        {
            if (_icon == null)
                return;
